...
! function(n) {
	function g(h) {
		...
		return n[h].call(u.exports, u, u.exports, g),
			u.l = !0,
			u.exports
	}
	var i = {};
	g.m = n,
		...
		g.d = function(n, i, h) {
			g.o(n, i) || Object.defineProperty(n, i, {
				configurable: !1,
				enumerable: !0,
				get: h
			})
	...
	var u = function() {
		...
		l = y.PinyinResource.getPinyinResource(),
		j = y.PinyinResource.getMutilPinyinResource(),
		c = "aeiouv",
	...
	g.PinyinHelper = function() {
		...
		return u(n, null, [{
				...
				value: function(n) {
					for (var g = n.split(","), i = g.length - 1; i >= 0; i--) {
						for (var h = !1, u = g[i].replace("ü", "v"), y = u.length - 1; y >= 0; y--) {
							var z = u.charAt(y);
							if (z < "a" || z > "z") {
								var o = s.indexOf(z),
									l = o % 4 + 1,
				...
				key: "_formatPinyin",
				value: function(n, g) {
					return g == o.WITH_TONE_MARK ? n.split(",") : g == o.WITH_TONE_NUMBER ? this._convertWithToneNumber(n) : g ==
						o.WITHOUT_TONE ? this._convertWithoutTone(n) : g == o.FIRST_LETTER ? this._convertWithoutTone(n) : []
				}
			}, {
				...
				value: function(n, g, i) {
					var h = [""],
						u = 0;
					n = z.ChineseHelper.convertToSimplifiedChinese(n);
					for (var y = 0, l = n.length, c = ""; y < l;) {
						var s = n.substring(y),
							x = this._getWords(s);
						if (0 == x.length) {
							var t = n.charAt(y);
							if (z.ChineseHelper.isChinese(t) || "〇" == t) {
								var d = this._convertToPinyinArray(t, i);
								d.length > 0 ? i == o.FIRST_LETTER ? (u++,
									h[u] = d[0].charAt(0)) : (u++,
									h[u] = d[0] + g) : h[u] += n.charAt(y)
							} else
								h[u] += n.charAt(y);
							y++
						} else {
							for (var q = x[x.length - 1], d = this._formatPinyin(j[q], i), b = 0, m = d.length; b < m; b++)
								i == o.FIRST_LETTER ? (u++,
									h[u] = d[b].charAt(0)) : (u++,
									h[u] = d[b] + g);
							y += q.length
					...
					for (var y = 0; y < h.length; ++y)
						if ("" !== h[y]) {
							var p = new RegExp(g + "$");
							p.test(h[y]) ? c += h[y].replace("undefined", "").substring(0, h[y].length - g.length) + g : c += h[y].replace(
								"undefined", "") + g
						}
					return c[c.length - 1] === g ? c.substring(0, c.length - g.length) : c
				}
			}, {
				key: "getShortPinyin",
				value: function(n) {
					return this.convertToPinyinString(n, "", o.FIRST_LETTER)
				}
			}, {
				key: "hasMultiPinyin",
				value: function(n) {
					var g = l[n];
					return void 0 !== n && g.split(",").length > 1
				}
			}, {
	...
	var u = function() {
		...
		y = i(2),
		z = /^[\u4e00-\u9fa5]+$/,
		o = y.PinyinResource.getChineseResource();
	...
	g.PinyinResource = function() {
		...
		return u(n, null, [{
				...
				value: function() {
					return o.pinyin_dict
				}
			}, {
				key: "getMutilPinyinResource",
				value: function() {
					return z.mutil_pinyin_dict
				}
			}, {
				key: "getChineseResource",
				value: function() {
					return y.chinese_dict
				}
			}]),
			n
	}()
	...
	(function(n) {
		...
		! function() {
			n.PinyinHelper = g.PinyinHelper,
				n.ChineseHelper = h.ChineseHelper,
				n.PinyinFormat = u.PinyinFormat
		}()
	}).call(g, i(3))
}, function(n, g, i) {
	"use strict";
